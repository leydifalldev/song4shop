<?php /* Smarty version Smarty-3.1.19, created on 2014-09-11 09:00:00
         compiled from "/Applications/MAMP/htdocs/prestashop/themes/default-bootstrap/shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:715987755541148704fbfe1-57782723%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '715987755541148704fbfe1-57782723',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54114870b40bf4_37868712',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54114870b40bf4_37868712')) {function content_54114870b40bf4_37868712($_smarty_tpl) {?>
...
<?php $_tmp44=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp42."&amp;ipa=".$_tmp43."&amp;id_address_delivery=".$_tmp44."&amp;op=down&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp47=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp45."&amp;ipa=".$_tmp46."&amp;id_address_delivery=".$_tmp47."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp50=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp48."&amp;ipa=".$_tmp49."&amp;id_address_delivery=".$_tmp50."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
